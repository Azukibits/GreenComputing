...
![GreenComputing screenshot](img_CN.png)
...
- 适合本地脚本和 CI 的命令行接口
- 支持 C、C++、Java、JavaScript、TypeScript、Go、C#、Rust、Python、PHP、Kotlin、Swift 源码检测
...
`demos/` 目前包含 C++、Python、PHP、Kotlin、Swift、Java、JavaScript、
TypeScript、Go、C#、Rust 的示例文件，方便你快速回归测试整个项目目录分析。
...
- [x] 命令行接口
- [x] 支持分析单个源文件和整个项目目录
- [x] 多语言函数提取：C、C++、Java、JavaScript、TypeScript、Go、C#、Rust、Python、PHP、Kotlin、Swift
